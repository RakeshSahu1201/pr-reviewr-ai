...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldID, user.FieldGitlabUserID:
	...
	for i := range columns {
		...
		case user.FieldGitlabUserID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.GitlabUserID = new(int)
				*_m.GitlabUserID = int(value.Int64)
			}
		case user.FieldCreatedAt:
...
func (_m *User) QueryToken() *UserTokenQuery {
