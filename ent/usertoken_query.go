...
func (_q *UserTokenQuery) QueryOwner() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2O, true, usertoken.OwnerTable, usertoken.OwnerColumn),
		)
...
func (_q *UserTokenQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserTokenQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserTokenQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserTokenQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserTokenQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserTokenQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserTokenQuery) WithOwner(opts ...func(*UserQuery)) *UserTokenQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserToken, error) {
	...
	if query := _q.withOwner; query != nil {
		if err := _q.loadOwner(ctx, query, nodes, nil,
			func(n *UserToken, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserTokenQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*UserToken, init func(*UserToken), assign func(*UserToken, *User)) error {
