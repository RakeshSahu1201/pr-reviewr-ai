...
func (_q *UserQuery) QueryToken() *UserTokenQuery {
...
func (_q *UserQuery) WithToken(opts ...func(*UserTokenQuery)) *UserQuery {
	query := (&UserTokenClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadToken(ctx context.Context, query *UserTokenQuery, nodes []*User, init func(*User), assign func(*User, *UserToken)) error {
